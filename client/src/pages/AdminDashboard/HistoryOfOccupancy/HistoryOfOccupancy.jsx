...
const HistoryOfOccupancy = () => {
  ...
  const exportToPDF = () => {
    ...
    doc.setFontSize(16);
    doc.text("Classroom Occupancy History Report", 14, 15);

    doc.setFontSize(11);
    doc.text(`Date generated: ${generatedDate}`, 14, 23);

    doc.text(`Generated by: ${user.username}`, 14, 30);
    ...
    doc.save("occupancy_history.pdf");
  };
        ...
        <div className="px-6 py-4 overflow-auto h-[78vh]">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center">
              <label htmlFor="search" className="mr-2 text-lg text-black">
                Search:
              </label>
              <input
                type="text"
            ...
            <div className="flex items-center">
              <FaFileDownload
                className="mr-4 text-orange-500 cursor-pointer hover:text-orange-600"
                size={20}
                title="Export pdf"
                onClick={exportToPDF}
              />
              <label htmlFor="datePicker" className="cursor-pointer">
                <FaRegCalendarAlt
                  className="w-5 h-5 mr-2 text-orange-500 hover:text-orange-600"
                  title="Select a date"
                />
              </label>
              <DatePicker
