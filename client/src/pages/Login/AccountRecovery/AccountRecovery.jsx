    ...
    try {
      ...
      setTimeout(() => {
        ...
        if (message.type === "success") {
          navigate(
            `/accountRecovery/verification?email=${result.fetchedUser.email}`
          );
        }
        setMessage({
      ...
      <div className="relative bg-white py-4 rounded-xs shadow-lg w-[40vw] h-[70vh] flex flex-col justify-center overflow-y-auto">
        ...
        <div className="flex flex-col px-[4vw]">
          ...
          <div className="flex flex-col pb-10">
            <span className="text-lg font-semibold">Recover your account</span>
            <span className="pb-8 text-sm text-gray-500">
              Please enter your email address to find your account.
            </span>
            <form onSubmit={handleSubmit}>
              <label htmlFor="forgotEmail" className="block mb-2 font-medium">
                Email Address
              </label>
              <Input
                type="email"
